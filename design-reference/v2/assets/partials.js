// Inject shared header + footer markup — V2 street food
(() => {
    ...
    <footer class="site-footer">
      <div class="container footer-grid">
        <div class="footer-brand">
          ...
          <p>Catering und Foodtruckservice aus Haldensleben — frisch gekocht, persönlich serviert. Für jeden Anlass, von zehn bis fünfhundert Gästen.</p>
        </div>
        ...
        <div class="footer-col">
          ...
          <ul>
            <li>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
              <a href="mailto:kontakt@velaro-catering.de">kontakt@velaro-catering.de</a>
            </li>
            <li>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.15 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.06 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.09 8.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21 16z"/></svg>
        ...
        <div class="footer-col">
          ...
          <ul class="hours-list">
            <li><span class="day">Mo – Fr</span><span class="time">08 — 18</span></li>
            <li><span class="day">Samstag</span><span class="time">09 — 14</span></li>
      ...
      <div class="container footer-bottom">
        <div class="left">
          <span>© 2026 Velaro · Catering &amp; Foodtruckservice</span>
        </div>
